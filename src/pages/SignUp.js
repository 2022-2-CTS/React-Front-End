            ...
            <div className="grid grid-cols-4 gap-3 ">
                ...
                <div className="col-span-3">
                    <label className="block">
                        ...
                        <input type="text" name="id" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-lg sm:text-sm focus:ring-1" 
                            onChange={saveUserId}
                        />
                    </label>
                </div>
                <div className="mt-6">
                    <button className="rounded-lg border-solid border-2 border-indigo-500 bg-indigo-500 py-2 w-full"
                        onClick={checkValidId}
                    >
                        <p className="text-white text-sm font-bold">확인</p>
                    </button>
                </div>
                <div className="col-span-3">
                ...
                <div className="col-span-4 mt-4">
                    <label className="block">
                        ...
                        <input type="password" name="password" className="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-lg sm:text-sm focus:ring-1" 
                            onChange={saveUserPw}
                        />
                    </label>
                </div>
                <div className="col-span-4">
                    <label className="block">
                        ...
                        <input type="password" name="password" className="mt-1 px-3 py-2 pr-1 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-lg sm:text-sm focus:ring-1" 
                ...
                </div>
                {
                    ...
                    : 
                    <div className="col-span-3">
                        {passwordMatch ? <p className="font-light text-sm font-bold text-green-600">비밀번호가 일치합니다.</p> : <p className="font-light text-sm font-bold text-rose-600">비밀번호를 다시 확인해 주세요.</p>}
                    </div>
                }
                <div className="col-span-4 mt-4">
                    {
                        finish
                        ?
                        <button className="rounded-lg border-solid border-2 border-indigo-500 bg-indigo-500 w-full py-2"
                            onClick={complete}>
