  ...
  return (
    <React.Fragment>
      ...
      <div className="w-5/6 m-auto">
        ...
        <div className=" m-auto my-3 text-xl">위치</div>
        ...
        <div class="grid grid-cols-4 gap-5  m-auto mt-8">
        ...
        <button className="flex justify-center rounded-2xl border-2 bg-[#1F83EB] m-auto  py-4 ">
